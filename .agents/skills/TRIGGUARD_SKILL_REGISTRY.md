# TrigGuard-Integrations — Project Skills Registry
...
**CI, gateways, infra integration examples.**

| Skill | Use |
|-------|-----|
| `spec-driven-development` | New integration README + contract alignment |
| `mcp-builder`, `connect` | Agent/tool gateway patterns |
| `vibe-guard` | Example gates must not leak secrets or skip PERMIT |
